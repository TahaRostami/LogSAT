...
# If an edge exists in the complement graph, both vertices cannot be chosen
for u,v in G_prim.edges:
    wcnf.append([-V(u),-V(v)])

# Soft constraints to maximize the clique size
for i in G_prim.nodes:
